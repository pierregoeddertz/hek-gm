...
export default function Home() {
  return (
    <main>
      ...
      <Unit identity="vertical 1 a spacingTop spacingBottom" style={{ maxWidth: '318px' }}>
      <Explorer>
        {/* Heizung */}
        <div style={{ position: 'relative', marginRight: '80px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--v_4)', color: 'var(--clrL_b)', textAlign: 'center', paddingTop: 'calc(42px + var(--v_6))' }}>
          <svg viewBox="0 0 322 381" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: 'var(--max_3)', color: 'var(--clrL_b)' }}>
        ...
        {/* Elektrik */}
        <div style={{ position: 'relative', marginRight: '66px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--v_4)', color: 'var(--clrL_b)', textAlign: 'center', paddingBottom: '42px' }}>
          <Arm direction="down" label="Elektrik" onClick={() => handleClick('elektrik')} />
          <svg viewBox="0 0 275 381" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: 'var(--max_3)', color: 'var(--clrL_b)' }}>
        ...
        {/* Klima */}
        <div data-first style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--v_4)', color: 'var(--clrL_b)', textAlign: 'center', paddingTop: 'calc(42px + var(--v_6))' }}>
          <svg viewBox="0 0 333 381" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: 'var(--max_3)', color: 'var(--clrL_b)' }}>
      ...
      <Scroller />
      <Unit identity="widthMax paddingX paddingY spacingTop">
        <Introducer
          index="01"
          label="Intro"
          title="Willkommen auf unserer Seite!"
