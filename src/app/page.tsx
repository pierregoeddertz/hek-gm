      ...
      <Unit second={{ spacingB: true, style: { paddingLeft: '0', paddingRight: '0' } }}>
        <Dragger style={{ paddingLeft: 'calc((100vw - 296px) / 2)', paddingRight: 'calc((100vw - 306px) / 2)' }}>
          ...
          <Director direction="v 3 1" style={{ gap: '2.5rem' }}>
            ...
            <Arm ref={armRef} side="right" label="Heizung" onClick={() => alert('heizung')} style={{ width: '140%', marginLeft: '-60px' }} />
          </Director>
          {/* Elektrik */}
          <Director direction="v 1 1" style={{ gap: '2.5rem' }}>
            <Arm direction="down" label="Elektrik" onClick={() => alert('elektrik')} style={{ width: '140%' }} />
          ...
          <Director direction="v 1 1" style={{ gap: '2.5rem' }}>
            ...
            <Arm side="left" label="Klima" onClick={() => alert('klima')} style={{ width: '140%' }} />
          </Director>
        </Dragger>
      </Unit>
